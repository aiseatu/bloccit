...
describe("routes : posts", () => {
  ...
  //Member user context: show, new, create
  ...
  //Owner user context: show, destroy, edit, update
  ...
  //Admin user context: new, create, show, destroy, edit, update
